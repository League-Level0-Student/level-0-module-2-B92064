...
public class RockPaperScissors extends JPanel implements ActionListener {
	...
	public void run() {
		...
		try {
			...
			paperImage = new ImageIcon(getClass().getResource("paper_title.png"));
			scissorsImage = new ImageIcon(getClass().getResource("big-siscors.jpg"));
	...
	public void actionPerformed(ActionEvent e) {
		...
		// 3. Change the value of opponentSelection to be a random number between 0 and
		// 2;
		Random numbernumber = new Random();
		int opponentSelection = numbernumber.nextInt(3);
